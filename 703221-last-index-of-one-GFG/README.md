# [Last index of One](https://www.geeksforgeeks.org/problems/last-index-of-15847/1?utm=codolio)
## Easy
...
Expected Time Complexity: O(n)Expected Auxillary Space: O(1)
Constraints: 1 &lt;= |s| &lt;= 106s = {0,1}